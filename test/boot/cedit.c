...
/* Check the cedit write_fdt command */
static int cedit_write_fdt(struct unit_test_state *uts)
{
	...
	for (i = 0, ofnode_first_property(node, &prop);
	     ofprop_valid(&prop);
...
BOOTSTD_TEST(cedit_write_fdt, 0);
