...
#define ROM_VERSION_A0		CONFIG(IMX8MQ) ? 0x800 : 0x800
#define ROM_VERSION_B0		CONFIG(IMX8MQ) ? 0x83C : 0x800
...
#define MXS_LCDIF_BASE		CONFIG(IMX8MQ) ? \
...
#define ROM_SW_INFO_ADDR_B0	(CONFIG(IMX8MQ) ? 0x00000968 :\
				 0x000009e8)
