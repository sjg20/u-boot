 ...
 *
 * Taken from src/soc/intel/tigerlake/include/soc h in coreboot
 */

#ifndef _ASM_ARCH_GPIO_DEFS_PCH_H_H_
#define _ASM_ARCH_GPIO_DEFS_PCH_H_H_

#ifndef __ACPI__
#include <stddef.h>
#endif
#include <asm/arch/gpio_soc_defs_pch_h.h>
