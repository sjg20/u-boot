...
/*
 * Definitions for the Tigerlake I/O map
 *
 * Taken from src/soc/intel/tigerlake/include/soc in coreboot
 */

#ifndef _ASM_ARCH_IOMAP_H_
#define _ASM_ARCH_IOMAP_H_
...
#define IOMAP_P2SB_BAR		CONFIG_PCR_BASE_ADDRESS
#define IOMAP_P2SB_SIZE		(16 * 1024 * 1024)
