...
#define __CONFIG_NOT_ENABLED_1(option)        __CONFIG_IS_ENABLED_3(option, (0), (0))
#define __CONFIG_NOT_ENABLED_2(option, case1) __CONFIG_IS_ENABLED_3(option, case1, ())
#define __CONFIG_NOT_ENABLED_3(option, case1, case0) \
	__concat(__unwrap, config_enabled(0, 0)) (case1, case0)
...
/* CONFIG(FOO) is another name for CONFIG_IS_ENABLED() */
#define CONFIG(option, ...) CONFIG_IS_ENABLED(option, ##__VA_ARGS__)
