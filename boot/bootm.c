...
/**
 * bootm_pre_load() - Handle the pre-load procesing
 *
 * This can be used to do a fully signature check of the image, for example.
		      ...
		      ulong size)
{
	...
	ret = boot_get_fdt(buf, argc > 2 ? argv[2] : NULL, IH_ARCH_DEFAULT,
