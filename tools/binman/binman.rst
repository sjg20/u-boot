...
`LD_LIBRARY_PATH=~/lib` when running biman. If you want to install it in the
...
image description. It may handle parts of the image naively and part with
various bintools.
...
For details on the various bintools supported by binman bintools.rst which is
