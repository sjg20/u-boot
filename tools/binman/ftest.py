...
'  fdtmap             90   243  fdtmap          90',
    ...
    def testVpl(self):
        ...
        # ELF file with a '__bss_size' symbol
        self._SetupVplElf()
        data = self._DoReadFile('252_u_boot_vpl.dts')
    ...
    def testVplNoDtb(self):
        ...
        self._SetupVplElf()
        data = self._DoReadFile('253_u_boot_vpl_nodtb.dts')
    ...
    def testExpandedVpl(self):
        ...
        self._DoReadFileDtb('254_fdt_incl_vpl.dts', use_expanded=True,
                            entry_args=entry_args)
        image = control.images['image']
        entries = image.GetEntries()
        self.assertEqual(1, len(entries))
    ...
    def testVplBssPadMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('255_vpl_bss_pad.dts')
