...
Here is the help:
    ...
    /tmp/aml_encrypt_g12b --rsagen --keylen len --exp exp --ned rkey --nex puk --nxd prk --txt tkey --aes akey
    ...
    /tmp/aml_encrypt_g12b --keysig --rkey1 rsakey [--rkey2 ..][--rkey3 ..][--rkey4 ..] --ukey1 rsakey --skey rsakey --output sig-rsa-key
    ...
    /tmp/aml_encrypt_g12b --keybnd --ukey file --rootkeymax file [--aeskey file] --output file
    ...
    /tmp/aml_encrypt_g12b --bootsig --input file --amluserkey file --output file
    ...
    /tmp/aml_encrypt_g12b --imgsig --input file --amluserkey file --output file
            input      : image to be processed for secure boot
            amluserkey : amlogic key package for secure boot
            output     : signatured and encrypted kernel image

    /tmp/aml_encrypt_g12b --binsig --input file --amluserkey file --output file
...
class Bintoolaml_encrypt_g12b(bintool.Bintool):
    ...
    def fetch(self, method):
        ...
        fname, tmpdir = self.fetch_from_drive(
            '1rYZHuqk4X9wTmRsxgBRvJc8DZAR1axOL')
        return fname, tmpdir
