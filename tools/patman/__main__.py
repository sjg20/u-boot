...
def run_patman():
    ...
    send.add_argument(
        '--no-tags', action='store_false', dest='process_tags',
    ...
    # Check status of patches in patchwork
        ...
        ret_code = 0
        try:
            control.patchwork_status(args.branch, args.count, args.start,
                                     args.end, args.dest_branch, args.force,
