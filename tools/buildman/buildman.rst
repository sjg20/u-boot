...
'tegra20'
   All boards with a Tegra20 SoC

'tegra'
   All boards with any Tegra Soc (Tegra20, Tegra30, Tegra114...)

'^tegra[23]0$'
   All boards with either Tegra20 or Tegra30 SoC
...
'freescale & arm sandbox'
   All Freescale boards with ARM architecture, plus sandbox
