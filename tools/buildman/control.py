...
def get_boards_obj(output_dir, regen_board_list, threads, verbose):
    ...
    Args:
        ...
        verbose (bool): False to supress output from boards-file generation
...
def adjust_options(args, series, selected):
